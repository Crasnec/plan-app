...
전용 Bearer 키를 사용하는 `/api/agent/v1` API를 추가했습니다. 읽기·쓰기·삭제 권한, 만료·폐기, 재시도 중복 방지와 요청 감사 기록을 제공합니다. 키 관리 UI는 설정에 있으며 MCP는 제공하지 않습니다. 키 발급과 호출 예시, OpenAPI 경로 및 OAuth 주소는 [AGENT_API.md](AGENT_API.md)에 있습니다.
